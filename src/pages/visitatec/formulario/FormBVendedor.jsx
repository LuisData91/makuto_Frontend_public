...
import { listarVendedores } from '../../vendedor/servicio/vendedorService';

const FormBVendedor = ({ show, onClose, onSelect }) => {
    ...
    const fetchData = async () => {
        try {
            setLoading(true);
            const { data, pagination: pg } = await listarVendedores({
                q,
                page,
                per_page: perPage,
            });
                ...
                <div className="modal-dialog modal-xl modal-dialog-scrollable">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Buscar Vendedor</h5>
