...
import { listarMotivos } from '../../motivo/servicio/motivoService';

const FormBMotivo = ({ show, onClose, onSelect }) => {
    ...
    const fetchData = async () => {
        try {
            setLoading(true);
            const { data, pagination: pg } = await listarMotivos({
                q,
                page,
                per_page: perPage,
            });
                ...
                <div className="modal-dialog modal-xl modal-dialog-scrollable">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Buscar Motivo</h5>
